...
#define VISION_PARAM_DESCRIPTION \
    "The exact and literal question asked by the user so that the vision system knows which element of the scene to focus its analysis on. For example: 'What does that sign say?', 'What color is that chair?'."
 ...
 */
#define INSTRUCTIONS_AUDIO_VISION "You are Jarvis, a AI resident in your wearer's glasses (mode audio+vision). You can see using the function look_aroud."
#ifdef __cplusplus
}
#endif
